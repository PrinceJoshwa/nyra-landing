...
//       <section
//         id="overview"
//         className="pt-24 sm:pt-32 lg:pt-36 pb-16 sm:pb-20 lg:pb-24 bg-gradient-to-br from-orange-50 via-white to-red-50 relative overflow-hidden"
//       >
...
//       <section
//         id="floor-plans"
//         className="py-16 sm:py-16 lg:py-32 bg-gradient-to-br from-slate-50 to-slate-100 relative"
//       >
...
//                   <div className="text-2xl sm:text-3xl font-bold text-orange-600 mb-1 sm:mb-2">₹2.8Cr*</div>
...
//         <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,rgba(251,146,60,0.05),transparent_50%)]"></div>
//         <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
//           <div className="text-center mb-16 sm:mb-20 lg:mb-24">
...
//                   </p>
//                   <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 sm:p-6 rounded-2xl border border-orange-100">
//                     <div className="flex items-center space-x-2">
//                       <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 text-orange-600 flex-shrink-0" />
//                       <span className="text-sm sm:text-base text-orange-800 font-semibold">
...
//       <section id="location" className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-orange-50 to-red-50 relative">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Testimonials Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-slate-50 to-slate-100 relative">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,rgba(251,146,60,0.05),transparent_50%)]"></div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16 sm:mb-20 lg:mb-24">
            <Badge className="bg-yellow-100 text-yellow-800 border border-yellow-200 mb-6 sm:mb-8 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-medium">
